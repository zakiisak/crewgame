...
namespace zakix {
	...
	void Shader::setUniform1fv(GLint location, float* value, int count)
	{
	...
	void Shader::setUniform1iv(GLint location, int* value, int count)
	{
		glUniform1iv(location, count, value);
	}

	void Shader::setUniform2f(GLint location, const vec2& vector)
	{
		glUniform2f(location, vector.x, vector.y);
	}

	void Shader::setUniform3f(GLint location, const vec3& vector)
	{
		glUniform3f(location, vector.x, vector.y, vector.z);
	}

	void Shader::setUniform4f(GLint location, const vec4& vector)
	{
		glUniform4f(location, vector.x, vector.y, vector.z, vector.w);
	}

	void Shader::setUniformMat4(GLint location, const mat4& matrix)
	{
